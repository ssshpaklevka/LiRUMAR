...
const ProductCard: FC<Props> = ({ id, name, price }) => {
  ...
  return (
    <Link
      className="hover:scale-95 transition-all duration-300 flex flex-col gap-[20px] h-full"
      href={`/catalog/${id}`}
    >
      ...
      <div className="flex flex-col gap-[14px] md:gap-[10px] 2xl:gap-[32px] min-h-[80px] md:min-h-[100px]">
