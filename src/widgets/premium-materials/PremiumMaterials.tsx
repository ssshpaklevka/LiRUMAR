        ...
        <div className="flex flex-col gap-[30px] sm:gap-[40px] md:gap-[30px] 3xl:gap-[65px]">
          ...
          <div className="relative block md:hidden">
            <motion.h1
              ...
              initial="hidden"
              animate={inView ? 'visible' : 'hidden'}
              className="font-normal text-[30px] leading-[33px] ms:text-[20px] ms:leading-[20px] ms:max-w-[200px] sam:text-[25px] sam:leading-[25px] sam:max-w-[220px] sm:max-w-[300px] md:text-[42px] md:leading-[47px] lg:text-[50px] lg:leading-[55px] xl:text-[66px] xl:leading-[59px] 3xl:text-[80px] 3xl:leading-[72px] max-w-[311px] md:max-w-[586px]"
            >
              <p>Исключительная</p>
            ...
            <motion.p
              ...
              initial="hidden"
              animate={inView ? 'visible' : 'hidden'}
              className="absolute right-0 bottom-0 md:bottom-[-30px] text-[14px] leading-[19px] ms:text-[12px] ms:leading-[12px] sam:text-[15px] sam:leading-[18px] md:text-[25px] md:leading-[35px] lg:text-[50px] lg:leading-[55px] xl:text-[66px] xl:leading-[59px] 3xl:text-[80px] 3xl:leading-[72px]"
            >
