...
const Footer: FC = () => {
  return (
    <footer className="px-5 pt-[74px] sm:pt-[120px] md:pt-[100px] 2xl:pt-[200px] grid md:grid-rows-custom-footer grid-rows-custom-footer-md md:grid-cols-4 md:gap-x-8 grid-cols-2 gap-x-12 mt-[150px] mx-auto">
      ...
      <Link
        href={'/privacy'}
        className="sm:text-[25px] sm:leading-[35px] md:text-[14px] md:leading-[12px] opacity-[30%] md:col-start-4 md:row-start-4 col-start-1 row-start-6 self-center 2xl:text-[19px] 2xl:leading-[16px]"
      >
